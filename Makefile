...
SRC = ./src/minishell.c ./src/shlvl.c ./src/expander.c ./src/utils.c ./src/builtins/builtins.c ./src/signal.c ./src/parserone.c ./src/logo.c ./src/overexpander.c \
		...
		./src/builtins/export_manage.c ./src/tokenize_redir.c ./src/builtins/unset.c ./src/builtins/env.c ./src/executor/executor.c ./src/executor/one_command.c ./src/executor/utils.c
OBJ = $(SRC:.c=.o)
LIBFT_DIR = Libft
