...
SRC = ./src/minishell.c ./src/shlvl.c ./src/expander.c ./src/utils.c ./src/builtins/builtins.c ./src/signal.c ./src/parserone.c ./src/logo.c ./src/overexpander.c \
		...
		./src/executor/one_command.c ./src/executor/utils.c ./src/executor/multi_command.c ./src/executor/files_io.c ./src/executor/childs.c ./src/executor/her_doc.c ./src/errors.c 
OBJ = $(SRC:.c=.o)
LIBFT_DIR = Libft
